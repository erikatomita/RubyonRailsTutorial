...
<<<<<<< HEAD
@heroku-cli/plugin-run/7.32.0 darwin-x64 node-v10.16.0
=======
...
_See code: [src/commands/logs.ts](https://github.com/heroku/cli/blob/v7.32.0/src/commands/logs.ts)_
...
_See code: [src/commands/run/index.ts](https://github.com/heroku/cli/blob/v7.32.0/src/commands/run/index.ts)_
...
_See code: [src/commands/run/detached.ts](https://github.com/heroku/cli/blob/v7.32.0/src/commands/run/detached.ts)_
...
_See code: [src/commands/run/inside.ts](https://github.com/heroku/cli/blob/v7.32.0/src/commands/run/inside.ts)_
=======
# Commands
<!-- commands -->
